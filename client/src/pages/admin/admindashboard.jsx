...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchUtilization = async () => {
      try {
        const res = await axios.get(`${baseUrl}/ai/space-utilization`);
  ...
  useEffect(() => {
    const fetchWarehouseStock = async () => {
      try {
        const res = await axios.get(`${baseUrl}/stock/warehouse-category-stock`);
  ...
  useEffect(() => {
    const fetchGlobalStock = async () => {
      try {
        const res = await axios.get(`${baseUrl}/stock/total-stock`);
      ...
      try {
        ...
        const results = await Promise.all(
          warehouses.map(async (wh) => {
            const res = await axios.get(`${baseUrl}/revenue/warehouse/${wh}`);
            return {
              wh,
  ...
  useEffect(() => {
    ...
    const fetchRevenue = async () => {
      try {
        const res = await axios.get(`${baseUrl}/total-revenue`);
  ...
  useEffect(() => {
    const fetchAdminIntelligence = async () => {
      try {
        const res = await axios.get(`${baseUrl}/strategic-intelligence`);
  ...
  const handleReportAction = async () => {
    ...
    try {
      const reportRes = await axios.get(`${baseUrl}/api/audit-report`);
      ...
      try {
        const results = await Promise.all(
          categories.map(async (cat) => {
            const res = await axios.get(`${baseUrl}/api/audit-summary?store=${store}&category=${cat}`);
  ...
  const fetchMarketAudit = async (warehouseId) => {
    try {
      const res = await axios.get(`${baseUrl}/market-audit/market-audit/${warehouseId}`);
